...
export const AVAILABLE_FIELDS: FieldOption[] = [
  { key: 'codeGroup', label: 'شماره و گروه درس', defaultSelected: false },
  { key: 'name', label: 'نام درس', defaultSelected: false },
  { key: 'totalUnits', label: 'واحد (کل)', defaultSelected: false },
  { key: 'practicalUnits', label: 'واحد عملی (ع)', defaultSelected: false },
  { key: 'capacity', label: 'ظرفیت', defaultSelected: false },
  { key: 'registered', label: 'ثبت‌نام شده', defaultSelected: false },
  { key: 'waitingList', label: 'لیست انتظار', defaultSelected: false },
  { key: 'gender', label: 'جنسیت', defaultSelected: false },
  { key: 'instructor', label: 'نام استاد', defaultSelected: false },
  { key: 'scheduleLocation', label: 'زمان و مکان ارائه', defaultSelected: false },
  { key: 'examSchedule', label: 'زمان و مکان امتحان', defaultSelected: false },
  { key: 'restrictions', label: 'محدودیت اخذ', defaultSelected: false },
  { key: 'cohort', label: 'مخصوص ورودی', defaultSelected: false },
